...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public void updateDrivePID(double p, double i, double d) {
    driveConfig.Slot0 = new Slot0Configs().withKP(p).withKI(i).withKD(d);
    tryUntilOk(5, () -> driveTalon.getConfigurator().apply(driveConfig, 0.25));
  }

  @Override
  public void updateTurnPID(double p, double i, double d) {
    turnConfig.Slot0 = new Slot0Configs().withKP(p).withKI(i).withKD(d);
    tryUntilOk(5, () -> turnTalon.getConfigurator().apply(turnConfig, 0.25));
  }
  ...
  public void setDriveVelocity(double velocityRadPerSec) {
    ...
    // safety purposes only, take out after tuning
    if (velocityRadPerSec == 0) {
      driveTalon.setControl(voltageRequest.withOutput(0.0));
    } else {
