...
public class SuperState {
    ...
    public SuperState(Translation2d endEffectorPos, boolean isCoral) {
        Translation3d guh = fromPose(endEffectorPos, isCoral);
    ...
    public SuperState(SuperTrajState trajectory_state, boolean isCoral) {
    ...
    public SuperState(double wrist, double arm, double ele, boolean isCoral) {
        wrist_angle = wrist;
        arm_angle = arm;
        elevator_height = ele;
    }
    ...
    public static enum SuperPreset{
        L4_CORAL(
            new SuperState(
                ElevatorPreset.L4.height, -25, -30, true)),
        L3_CORAL(
            new SuperState(
