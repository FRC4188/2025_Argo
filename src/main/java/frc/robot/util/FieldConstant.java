...
public class FieldConstant {
  ...
  // starting positions
  // no vision
  // public static Pose2d start_mid = new Pose2d(7.1, Reef.AlgaeSource.mid_brg_src.getY(),
  // Rotation2d.k180deg);
  ...
  public class Field {
    ...
    public static Pose2d innerCageStart =
        new Pose2d(new Translation2d(8.007, 5.047), new Rotation2d(0.0));
    public static Pose2d middleCageStart =
        new Pose2d(new Translation2d(8.007, 6.164), new Rotation2d(0.0));
    public static Pose2d outterCageStart =
        new Pose2d(new Translation2d(8.007, 7.261), new Rotation2d(0.0));
  ...
  public class Cage {
    ...
    static {
      cage_positions[0] =
          new Translation3d(
              field_center_x, field_center_y - Units.inchesToMeters(127.375), shallow_height);
      cage_positions[1] =
          new Translation3d(
              field_center_x, field_center_y - Units.inchesToMeters(84.375), shallow_height);
      cage_positions[2] =
          new Translation3d(
              field_center_x, field_center_y - Units.inchesToMeters(41.5), shallow_height);
      cage_positions[3] =
          new Translation3d(
              field_center_x, field_center_y + Units.inchesToMeters(41.5), shallow_height);
      cage_positions[4] =
  ...
  public class Reef {
    ...
    public class DeSource {
      ...
      public static List<Pose2d> dsources =
          new LinkedList<Pose2d>(
              Arrays.asList(
                  alliance_src,
                  left_brg_src,
  ...
  public class Elem_Locations {
    ...
    static {
      for (int i = 0; i < 3; i++) {
        corals_locations[i] =
            new Translation2d(distance_x, field_center_y - distance_apart + i * distance_apart);
        algae_locations[i] =
            new Translation3d(
                corals_locations[i].getX(),
                corals_locations[i].getY(),
                coral_length + algae_radius);
      }
    }
  }
  ...
  public class Source {
    ...
    public static Pose2d right_approach_bottom_src =
        new Pose2d(0.650, 1.410, Rotation2d.fromDegrees(-125));
    public static Pose2d left_approach_bottom_src =
        new Pose2d(1.700, 0.650, Rotation2d.fromDegrees(-125));
    public static Pose2d middle_approach_bottom_src =
        new Pose2d(1.175, 1.030, Rotation2d.fromDegrees(-125));

    public static Pose2d right_approach_top_src =
        new Pose2d(1.700, 7.370, Rotation2d.fromDegrees(125));
    public static Pose2d left_approach_top_src =
        new Pose2d(0.650, 6.600, Rotation2d.fromDegrees(125));
    public static Pose2d middle_approach_top_src =
        new Pose2d(1.175, 6.985, Rotation2d.fromDegrees(125));
