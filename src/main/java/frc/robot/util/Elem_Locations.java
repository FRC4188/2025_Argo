...
public class FieldConstant {
    ...
    public class Reef{
        ...
        public class CoralStationLocations {
            
            public static Translation2d left_approach_bottom_coral_station = new Translation2d(1.7, 0.75);
            public static Translation2d middle_approach_bottom_coral_station = new Translation2d(1.2, 1.1);
            public static Translation2d right_approach_bottom_coral_station = new Translation2d(0.75, 1.45);

            public static Translation2d left_approach_top_coral_station = new Translation2d(0.75, 6.55);
            public static Translation2d middle_approach_top_coral_station = new Translation2d(1.25, 6.95);
            public static Translation2d right_approach_top_coral_station = new Translation2d(1.7, 7.3);

            //i can guarantee that this needs to be fixed - pathfinder rookie
            public static Pose2d left_BCS = new Pose2d(
                left_approach_bottom_coral_station, new Rotation2d(Degrees.of(-125)));
            
            public static Pose2d middle_BCS = new Pose2d(
                middle_approach_bottom_coral_station, new Rotation2d(Degrees.of(-125)));

            public static Pose2d right_BCS = new Pose2d(
                right_approach_bottom_coral_station, new Rotation2d(Degrees.of(-125)));

            public static Pose2d left_TCS = new Pose2d(
                left_approach_top_coral_station, new Rotation2d(Degrees.of(125)));

            public static Pose2d middle_TCS = new Pose2d(
                middle_approach_top_coral_station, new Rotation2d(Degrees.of(125)));

            public static Pose2d right_TCS = new Pose2d(
                right_approach_top_coral_station, new Rotation2d(Degrees.of(125)));
            }
        }
        }
