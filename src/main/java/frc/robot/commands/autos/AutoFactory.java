    ...
    public static Command leftCoralSource(Drive drive, Superstructure superstructure, Intake intake){
        ...
        return parallel(
            ...
            either(
                ...
                repeatingSequence(
                    new AutoScore(goal, SuperState.SuperPreset.L4_CORAL.getState(), drive, superstructure, intake, false),
                    new AutoScore(goal, SuperState.SuperPreset.SOURCE.getState(), drive, superstructure, intake, true),
